...
export default class StoresContainer extends Component{
  ...
  constructor(props, context) { 
    ...
    //if (state.params) {
      ...
      this.initialPage = this.props.route.params["initialPage"]? this.props.route.params["initialPage"]: 0;
      this.gotoStore = this.props.route.params["gotoStore"]? this.props.route.params["gotoStore"]: null;
    //}
  ...
  render(){
    return(
      <ScrollableTabView
        ...
        tabBarPosition='top' 
        onChangeTab={async (tab)=>{this._randomNumber(tab); this._registerAnalytics(tab.i) }}
        initialPage={this.initialPage}
      >
        <View 
          tabLabel="Todos" 
          style={layout.mainContainer}>
          <Stores navigator={this.navigator} 
        ...
        <View 
          tabLabel="Favoritos"
          style={layout.mainContainer}>
          <StoresFavorites navigator={this.navigator}
          tabsChange={this.state.tabsChange}
          sesion={this.sesion} />
        </View>
